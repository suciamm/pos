...
<div class="breadcrumb-holder container-fluid">
	<div class="row pt-3">
		...
		<div class="col-md-6 col-sm-12">
			...
			<li class="breadcrumb-item active"><b> Add <?php echo $product; ?></b></li>
			</ul>
		</div>
	</div>	
</div>
	...
	<div class="row">
		...
		<div class="card mb-0">
				<div class="col-md-12 mt-4">
					<div class="col-md-12">
					<i class="fa fa-info-circle"></i> NEW <?php echo strtoupper($product); ?> | <span>product</span>
					</div>					
				</div><hr>
				<div class="card-body mb-5">
					...
					<div class="col-md-12 col-sm-12">
						<div class="col-md-12 col-sm-12">						
						<form id="form_product_add" method="post" enctype="multipart/form-data">
							...
							<div class="row col-md-12 mt-3">								
								...
								<div class="row col-md-6 col-sm-12">
										...
										<input type="checkbox" class="check checkbox-template" name="status" value="not" checked="checked">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#product_code').blur(function() {
			...
			if(val != '') {
					...
					$.ajax({
						url 	: url,
						type 	: 'POST',
						data 	: {'data':val,'aksi':'check_product_code'},
						dataType: 'html',
		...
		$('#product').blur(function() {
			...
			if(val != '') {
					...
					$.ajax({
						url 	: url,
						type 	: 'POST',
						data 	: {'data':val,'aksi':'check_product'},
						dataType: 'html',
						success : function(response){
							var data = $.parseJSON(response);
		...
		$('#form_product_add').submit(function(e) {
			...
			if(valid) {
				loading("Please wait to adding data ...");	 
				$.ajax({
					url: url,
					type: 'POST',
