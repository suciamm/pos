	...
	<div class="row pt-3">
		<div class="row col-md-8 col-sm-12">
			<ul class="breadcrumb action-bar">				
				<li class="mr-4">
					<a href="#" id="add" data-id='index.php?page=menu&sub=add'>
					...
					<table class="table table-hover table-striped" id="view-table">
						...
						<tbody>
							...
							<tr>
								<td>
									<div class="i-checks">
									<input type="checkbox" class="check checkbox-template" name="id_menu[]" value="<?php echo $view['icon']; ?>">
									</div>
								</td>
								<td><?php echo $no++; ?></td>
								<td>
									<div class="image">
										<img src="image/upload/<?php echo $view['icon']; ?>" alt="..." class="img-fluid rounded-circle" width="30">
										<?php 
										echo $view['menu'];
										?>
									</div>
								...
								<td>
									<a href="index.php?page=menu&sub=edit&id=<?php echo base64_encode($view['id_menu']);  ?>">
									<i class="fa fa-pencil mr-1"></i>
									</a>
									
									<a href="#" data-toggle="modal" data-target="#btn_delete" data-id="<?php echo $view['icon']?>">
...
<div class="modal fade" id="modal_delete_all" data-backdrop="static">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<img src="image/assets/loading.gif" height="50">
			<span>Loading ... </span>
			</div>
		</div>
